...
public class OperatorMenuView extends JFrame {
    private Image backgroundImage;
    private Image logoImage;

    public OperatorMenuView(User user) {
        setTitle("SmartPark - Operator Dashboard");
        ...
        JLabel lblWelcome = new JLabel("Halo, " + user.getUsername() + " (Operator)");
        ...
        buttonPanel.setLayout(new GridLayout(1, 3, 40, 20));

        Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
        int buttonPanelWidth = 800;
        ...
        buttonPanel.add(createMenuButton("Lihat Laporan", () -> new ReportView(false)));
